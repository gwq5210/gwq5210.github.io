...
![存储每个文件和基础版本的差异](/images/存储每个文件和基础版本的差异.png)

![存储项目随时间变化的快照](/images/存储项目随时间变化的快照.png)
...
![Git仓库，工作目录以及暂存区域](/images/工作目录，暂存区域以及Git仓库.png)
...
![文件状态变化生命周期](/images/文件状态变化生命周期.png)
...
![本地与远程的工作可以分叉](/images/本地与远程的工作可以分叉.png)
...
![变基然后进行快进合并](/images/变基然后进行快进合并.png)

![通过合并操作来整合分叉的历史](/images/通过合并操作来整合分叉的历史.png)
