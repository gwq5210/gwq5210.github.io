...
![存储每个文件和基础版本的差异](https://gwq5210.com/images/存储每个文件和基础版本的差异.png)

![存储项目随时间变化的快照](https://gwq5210.com/images/存储项目随时间变化的快照.png)
...
![Git仓库，工作目录以及暂存区域](https://gwq5210.com/images/工作目录，暂存区域以及Git仓库.png)
...
![文件状态变化生命周期](https://gwq5210.com/images/文件状态变化生命周期.png)
...
![一个和并提交](https://gwq5210.com/images/一个和并提交.png)
...
![本地与远程的工作可以分叉](https://gwq5210.com/images/本地与远程的工作可以分叉.png)
...
![变基然后进行快进合并](https://gwq5210.com/images/变基然后进行快进合并.png)

![通过合并操作来整合分叉的历史](https://gwq5210.com/images/通过合并操作来整合分叉的历史.png)
